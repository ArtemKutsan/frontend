// Front-end 43.2 - Front-end. Консультация по проекту часть 1 (реализация рег)
/* App Todo */
...
// // Сохранение задачи (изменение существующей или добавление новой)
// const saveTodo = (id, title, date) =>
//   id ? editTodo(id, title, date) : addTodo(title, date);
